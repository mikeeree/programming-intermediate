...
def caesar_cipher(message, shift):
    ...
    return result#not in line with if and else bcs the result will be multiline
...
def scytale_cipher(message, shift):
    ...
    for i in range (0,len(message)):
        character=(i // shift) + (len(message) // shift) * (i % shift)
        letter=message[character]
        result+=letter
...
def scytale_decipher(message, shift):
    ...
    for i in range (shift):
        for nth_letter in range(i, len(message), shift):
            letter=message[nth_letter]
            result += letter
